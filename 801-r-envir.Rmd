...
**高知工科大学の矢内先生の[RとRStudioのインストール方法の解説](https://yukiyanai.github.io/jp/resources/)が有益なのでそちらをご覧ください。**
（一応、以下の記述は残してはおきます。）

- WSL2経由でR/RStudioを使いたい場合は[WindowsでR/RStudioをちゃんと使う方法]を参照してください。
